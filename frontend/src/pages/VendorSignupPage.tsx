                  ...
                  <div className="relative">
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                        className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl py-4 px-5 text-slate-900 font-bold outline-none focus:outline-none focus:ring-8 focus:ring-orange-500/10 focus:border-orange-200/50 transition-all placeholder:text-slate-400"
