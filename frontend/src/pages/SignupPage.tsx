        ...
        <form onSubmit={(e) => { 
          ...
          <div>
            ...
            <input type="text" value={form.full_name} onChange={(e) => update('full_name', e.target.value)} required
              className="w-full px-5 py-4 rounded-2xl bg-slate-50 border-2 border-slate-100 text-slate-900 placeholder-slate-400 outline-none focus:outline-none focus:ring-8 focus:ring-orange-500/10 focus:border-orange-200/50 transition-all shadow-sm font-bold"
